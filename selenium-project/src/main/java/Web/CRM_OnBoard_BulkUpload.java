...
public class CRM_OnBoard_BulkUpload {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String customerType = "Corporate";         //Corporate
        String filePath = "/Users/gouthambojja/Documents/Bulk Upload Template_Individual Customers.xlsx";
